 ...
 */
// TODO: Implement additional hooking method: real-time overwrite jmp
//       instruction with original bytes and execute them in original function.
//       This will allow to overwrite instructions required relation addresses.
